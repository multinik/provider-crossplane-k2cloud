...
// GetInitParameters of this LaunchPermission
func (tr *LaunchPermission) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LaunchPermission
func (tr *LaunchPermission) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
