...
type RouteTable struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.defaultRouteTableId) || (has(self.initProvider) && has(self.initProvider.defaultRouteTableId))",message="spec.forProvider.defaultRouteTableId is a required parameter"
