...
func (mg *Service) GetTerraformResourceType() string {
	return "aws_paas_service"
}

// GetConnectionDetailsMapping for this Service
func (tr *Service) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"elasticsearch[*].password": "elasticsearch[*].passwordSecretRef", "mongodb[*].user[*].password": "mongodb[*].user[*].passwordSecretRef", "mysql[*].user[*].password": "mysql[*].user[*].passwordSecretRef", "pgsql[*].user[*].password": "pgsql[*].user[*].passwordSecretRef", "rabbitmq[*].password": "rabbitmq[*].passwordSecretRef", "redis[*].password": "redis[*].passwordSecretRef"}
}
