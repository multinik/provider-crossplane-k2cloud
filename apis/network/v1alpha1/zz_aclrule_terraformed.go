...
// GetInitParameters of this ACLRule
func (tr *ACLRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ACLRule
func (tr *ACLRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
