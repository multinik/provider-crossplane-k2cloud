...
type TransitGatewayRouteTableAssociation struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.transitGatewayAttachmentId) || (has(self.initProvider) && has(self.initProvider.transitGatewayAttachmentId))",message="spec.forProvider.transitGatewayAttachmentId is a required parameter"
