...
type GroupPolicyAttachment struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.groupArn) || (has(self.initProvider) && has(self.initProvider.groupArn))",message="spec.forProvider.groupArn is a required parameter"
